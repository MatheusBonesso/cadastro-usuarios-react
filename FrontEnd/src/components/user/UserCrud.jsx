            ...
            <div className="form">
                <div className="row">
                    ...
                    <div className="col-12 col-md-6">
                        <div className="form-group">
                            <label>E-mail</label>
                            <input name="email" className="form-control" value={this.state.user.email} onChange={e => this.updateField(e)} placeholder="Digite o e-mail" />
                        </div>
                    </div>
                </div>
                <div className="row">
        ...
        return this.state.list.map(user => {
            return (
                <tr key={user.id}>
                    ...
                    <td>{user.email}</td>
                    <td>
                        <button className="bt btn-warning" onClick={() => { this.load(user) }}>
